...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "example_site.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
ACCOUNT_FORMS = {"signup": "example_site.users.forms.UserSignupForm"}
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "example_site.users.adapters.SocialAccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/forms.html
SOCIALACCOUNT_FORMS = {"signup": "example_site.users.forms.UserSocialSignupForm"}
