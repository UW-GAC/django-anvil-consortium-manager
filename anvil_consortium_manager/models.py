...
class Workspace(TimeStampedModel):
    ...
    workspace_data_type = models.CharField(max_length=255)
    ...
    @classmethod
    def anvil_import(cls, billing_project_name, workspace_name, workspace_data_type):
        ...
        try:
            with transaction.atomic():
                ...
                workspace = cls(
                    name=workspace_name, workspace_data_type=workspace_data_type
                )
