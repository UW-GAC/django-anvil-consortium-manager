...
class IgnoredManagedGroupMembershipTest(TestCase):
    """Tests for the IgnoredManagedGroupMembership model."""

    def test_model_saving(self):
        """Creation using the model constructor and .save() works."""
        group = factories.ManagedGroupFactory.create()
        user = factories.UserFactory.create()
        instance = IgnoredManagedGroupMembership(
            group=group,
        ...
        instance.save()
        self.assertIsInstance(instance, IgnoredManagedGroupMembership)
    ...
    def test_history(self):
        ...
        # An entry is created upon deletion.
        obj.delete()
        self.assertEqual(IgnoredManagedGroupMembership.history.count(), 3)
